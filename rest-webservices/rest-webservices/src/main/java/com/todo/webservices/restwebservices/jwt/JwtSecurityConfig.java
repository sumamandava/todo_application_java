/*
 * package com.todo.webservices.restwebservices.jwt;
 * 
 ...
 * 
 * import com.nimbusds.jose.JOSEException; import com.nimbusds.jose.jwk.JWKSet;
 * import com.nimbusds.jose.jwk.RSAKey; import
 ...
 * @EnableWebSecurity
 * 
 * @EnableMethodSecurity public class JwtSecurityConfig {
 * 
 * @Bean public SecurityFilterChain securityFilterChain(HttpSecurity
 * httpSecurity, HandlerMappingIntrospector introspector) throws Exception {
 * 
 * // h2-console is a servlet //
 * https://github.com/spring-projects/spring-security/issues/12310 return
 ...
 * .httpBasic( Customizer.withDefaults()) .headers(headers ->
 ...
 * userDetailsService) { var authenticationProvider = new
 * DaoAuthenticationProvider();
 * authenticationProvider.setUserDetailsService(userDetailsService); return new
 * ProviderManager(authenticationProvider); }
 * 
 * @Bean public UserDetailsService userDetailsService() { UserDetails user =
 * User.withUsername("in28minutes") .password("{noop}dummy")
 * .authorities("read") .roles("USER") .build();
 * 
 * return new InMemoryUserDetailsManager(user); }
 * 
 * @Bean public JWKSource<SecurityContext> jwkSource() { JWKSet jwkSet = new
 * JWKSet(rsaKey()); return (((jwkSelector, securityContext) ->
 * jwkSelector.select(jwkSet))); }
 * 
 * @Bean JwtEncoder jwtEncoder(JWKSource<SecurityContext> jwkSource) { return
 * new NimbusJwtEncoder(jwkSource); }
 * 
 * @Bean JwtDecoder jwtDecoder() throws JOSEException { return NimbusJwtDecoder
 ...
 * return keyPairGenerator.generateKeyPair(); } catch (Exception e) { throw new
 * IllegalStateException( "Unable to generate an RSA Key Pair", e); } }
 * 
 * }
 * 
 * 
